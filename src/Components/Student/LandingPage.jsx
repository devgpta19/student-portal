...
function LandingPage() {
  return (
    <div className="bg-gradient-to-r from-blue-100 via-white to-blue-200 min-h-screen w-screen flex flex-col items-center justify-center font-sans px-6 sm:px-8 py-6 md:px-10 overflow-hidden">
      {/* Header Section */}
